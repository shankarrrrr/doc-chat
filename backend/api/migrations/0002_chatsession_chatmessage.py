# Generated by Django 5.2.9 on 2026-01-10 08:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='chat_sessions', to='api.profile')),
            ],
            options={
                'ordering': ['-updated_at'],
            },
